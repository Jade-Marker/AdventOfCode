...
int main()
{
	...
	constexpr int cTotalDiskSpace = 70000000;
	constexpr int cSpaceNeedForUpdate = 30000000;
	...
	int spaceRequired = cSpaceNeedForUpdate - (cTotalDiskSpace - root.GetSize());

	std::cout << "Smallest directory to delete is size " << Node::FindSmallestAboveNum(&root, spaceRequired) << std::endl;
